    ...
    void Update()
    {
        ...
        if (timer < 0)
        {
            ...
            else if (Bullettype == 4)
            {
                ...
                PhotonNetwork.Instantiate(this.Bullet2.name, SquatsPoint11.transform.position, SquatsPoint11.transform.rotation, 0);
            ...
            else if (Bullettype == 5)
            {
                ...
                PhotonNetwork.Instantiate(this.Bullet3.name, SquatsPoint22.transform.position, SquatsPoint22.transform.rotation, 0);
            ...
            else if (Bullettype == 6)
            {
                ...
                PhotonNetwork.Instantiate(this.Bullet1.name, SquatsPoint33.transform.position, SquatsPoint33.transform.rotation, 0);
